...
class GroceryListViewController: UITableViewController{
    ...
    var showsGroceryList:Bool = true
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Groceries", for: indexPath) as! GroceryListCell
        cell.groceriesItem.text = groceriesList[indexPath.row]
